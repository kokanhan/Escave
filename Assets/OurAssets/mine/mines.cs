...
//    //        if (GameObject.Find("First Person Controller").GetComponent<HoeAction>().DigEnoughTime >= 3)
//    //        {
//    //            Debug.Log("hold enough time");
//    //            powder.SetActive(true);
//    //            GameObject.Find("First Person Controller").GetComponent<HoeAction>().DigEnoughTime = 0;
//    //            Destroy(gameObject);
//    //        }
//    //    }
//    //}
